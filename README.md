___It's an antipattern__ in case you want to inject __reactive dependencies__. Elaboration: if you'd make a watcher of a reactive instance that changes the value of injected reactive property, recursion is going to happen._
